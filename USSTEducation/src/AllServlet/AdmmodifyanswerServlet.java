...
@WebServlet(name = "AdmmodifyanswerServlet", value = "/AdmmodifyanswerServlet")
public class AdmmodifyanswerServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("AdmanswerMOd.jsp").forward(request,response);
    }
