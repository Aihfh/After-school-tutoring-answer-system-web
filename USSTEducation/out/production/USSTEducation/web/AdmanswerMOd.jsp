...
<form action="AdmmodifyanswerServlet" method="post">
    <table id="customers">
        <tr>
            <th>MessageId留言编号</th>
            <th>Name回答老师</th>
        ...
        <c:forEach var="t" items = "${applicationScope.nowann}" varStatus="status">
            <tr>
                <td><span><input type="text" name="fu1" value="${t.messageId}" readonly></span></td>
                <td><span>${t.tname}</span></td>
                <td class="price"><input type="text" name="newpic" maxlength="50" value="${t.apicture}" required></td>
                <td><span><input type="text"  name="newcont"  maxlength="200" value="${t.acontent}" required> </span></td>
