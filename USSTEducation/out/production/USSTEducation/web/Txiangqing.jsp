...
<form action="AnswerviewServlet" method="post">
    ...
    <div class="container1">
        <div class="row">
            <div class="col-25">
                <label for="ffname">当前回答老师为</label>
            </div>
            <div class="col-75">
        ...
        <div class="row">
            ...
            <div class="col-75">
                <input type="text" id="fname" class="shangchuan" name="Atitle" placeholder="Your title.."required>
            </div>
        </div>
        <div class="row">
            <div class="col-25">
            ...
            <div class="col-75">
                <textarea id="subject" name="Acontent" class="shangchuan" placeholder="Write something.." style="height:200px" required></textarea>
            </div>
