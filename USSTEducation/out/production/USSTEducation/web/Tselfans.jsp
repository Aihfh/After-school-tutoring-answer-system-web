    ...
    <table id="customers">
        ...
        <c:forEach var="t" items = "${applicationScope.selfans}" varStatus="status">
            <tr>
                ...
                <td><a type="button" class="btn btn-xs btn-warning" href="AnswermodifyServlet?messid=${t.messageId}">修改</a>
                    <a type="button" class="btn btn-xs btn-danger" href="AnswerDeleteServlet?messid=${t.messageId}">删除</a></td>
            </tr>
        </c:forEach>
    </table>
</form>
