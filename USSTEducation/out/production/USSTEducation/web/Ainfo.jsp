...
<c:forEach var="t" items="${applicationScope.Ainfo}" varStatus="status">
    <div class="alert alert-success" role="alert">
        <strong>管理员编号：</strong>${t.cid}
    </div>
    <div class="alert alert-info" role="alert">
        <strong>姓名：</strong> ${t.cname}<span><a type="button" class="btn btn-xs btn-warning"  href="AdminfochangeServlet?Cid=${t.cid}">修改</a></span>
    </div>
    <div class="alert alert-warning" role="alert">
        <strong>密码：</strong>${t.cpassword}<span><a type="button" class="btn btn-xs btn-warning" href="AdminfochangeServlet?Cid=${t.cid}">修改</a></span>
    </div>
</c:forEach>
