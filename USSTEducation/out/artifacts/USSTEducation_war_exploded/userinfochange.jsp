...
<form action="StudentinfochangeServlet" method="post">
<c:forEach var="m" items="${applicationScope.newuser}" varStatus="status">
    <div class="alert alert-success" role="alert">
        <strong>学号：</strong><label><input type="text" name="newid" value="${m.userid}" readonly></label>
    </div>
    <div class="alert alert-info" role="alert">
        <strong>用户名：</strong><label><input type="text" name="newuname" value="${m.UName}" required></label>
    </div>
    <div class="alert alert-warning" role="alert">
        <strong>密码：</strong> <label><input type="text" name="newpass" value="${m.UPassword}" required></label>
    </div>
    <div class="alert alert-danger" role="alert">
        <strong>真实姓名：</strong>${m.truename}
    </div>
