    ...
    <table id="customers">
        ...
        <c:forEach var="m" items = "${applicationScope.list}" varStatus="status">
            <tr>
                ...
                <td>
                    <a type="button" class="btn btn-xs btn-warning" href="AdmmesmodServlet?messid=${m.messageId}">修改</a>
                    <a type="button" class="btn btn-xs btn-danger" href="MessDeleteServlet?messid=${m.messageId}">删除</a>
                </td>
            </tr>
        </c:forEach>
    </table>
