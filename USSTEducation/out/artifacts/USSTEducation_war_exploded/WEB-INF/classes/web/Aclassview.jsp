        ...
        <div class="row">
            <div class="col-md-6">
                <table class="table table-striped">
                    ...
                    <tbody>
                    <c:forEach var="c" items = "${applicationScope.subject}" varStatus="status">
                        <tr>
                            <td><span>${c.CClass}</span></td>
                            <td><span>${c.tname}</span></td>
                            <td>
                                <span><a type="button" class="btn btn-xs btn-warning"  href="AdmnewclassServlet">增加</a></span>
                                <span><a type="button" class="btn btn-xs btn-warning"  href="AdmchangeclassServlet?C1name=${c.tname}">修改</a></span>
                                <span><a type="button" class="btn btn-xs btn-warning"  href="AdmDeleteclassServlet?C1id=${c.CClass}">删除</a></span>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
