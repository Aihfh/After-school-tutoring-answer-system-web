...
<form action="AdminfochangeServlet" method="post">
    <c:forEach var="t1" items="${applicationScope.newC}" varStatus="status">
        <div class="alert alert-success" role="alert">
            <strong>管理员编号：</strong><label><input type="text" name="newid" value="${t1.cid}" readonly></label>
        </div>
        <div class="alert alert-info" role="alert">
            <strong>姓名：</strong><label><input type="text" name="newuname" value="${t1.cname}" required></label>
        </div>
        <div class="alert alert-warning" role="alert">
            <strong>密码：</strong> <label><input type="text" name="newpass" value="${t1.cpassword}" required></label>
        </div>
