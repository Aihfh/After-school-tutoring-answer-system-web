    ...
    <table id="customers">
        ...
        <c:forEach var="m" items = "${applicationScope.list}" varStatus="status">
            <tr>
                ...
                <td><a type="button" class="btn btn-lg btn-primary" href="AnswerviewServlet?teid=${m.messageId}">回答</a></td>
                <td><a type="button" class="btn btn-lg btn-danger" href="TdeleteMESServlet?messid=${m.messageId}">删除</a></td>
            </tr>
        </c:forEach>
    </table>
</form>
