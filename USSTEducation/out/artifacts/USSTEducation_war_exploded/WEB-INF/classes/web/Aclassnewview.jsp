        ...
        <div class="row">
            <div class="col-md-6">
                <table class="table table-striped">
                    ...
                    <form action="AdmnewclassServlet" method="post">
                    <tr>
                        <td><input type="text" name="newteacherid" maxlength="20" value="请输入任课教师编号"></td>
                        <td><input type="text" name="newclass" maxlength="20" value="请输入课程名"></td>
                        <td><input type="text" name="newteacher" maxlength="20" value="请输入任课教师"></td>
                    </tr>
