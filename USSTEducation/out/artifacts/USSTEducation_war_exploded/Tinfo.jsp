...
<c:forEach var="t" items="${applicationScope.Tinfo}" varStatus="status">
    <div class="alert alert-success" role="alert">
        <strong>教师编号：</strong>${t.teacherid}
    </div>
    <div class="alert alert-info" role="alert">
        <strong>姓名：</strong> ${t.tname}<span><a type="button" class="btn btn-xs btn-warning"  href="TinfochangeServlet?Tid=${t.teacherid}">修改</a></span>
    </div>
    <div class="alert alert-warning" role="alert">
        <strong>密码：</strong>${t.tpassword}<span><a type="button" class="btn btn-xs btn-warning" href="TinfochangeServlet?Tid=${t.teacherid}">修改</a></span>
    </div>
    <div class="alert alert-danger" role="alert">
        <strong>学院：</strong>${t.tclass}
    </div>
    <div class="alert alert-danger" role="alert">
        <strong>简述：</strong>${t.tinfo}
    </div>
</c:forEach>
