...
<div class="container">
    ...
    <div class="container theme-showcase" role="main">
        ...
        <div class="row">
            <div class="col-md-6">
                <form action="AdmchangeclassServlet" method="post">
                <table class="table table-striped">
                    ...
                    <tbody>
                    <c:forEach var="c" items = "${applicationScope.nowclass}" varStatus="status">
                        <tr>
                            <td><span><label>
                                <input type="text" value="${c.tid}" name="mtid" required>
                            </label></span></td>
                            <td><span><label>
                                <input type="text" value="${c.CClass}" name="mclass" required>
                            </label></span></td>
                            <td><span><label>
                                <input type="text" value="${c.tname}" name="mname" required>
                            </label></span></td>
                        </tr>
                    </c:forEach>
                    </tbody>
