...
<tr class="cart">
    ...
    <table>
        <tr>
        <td>搜索栏<input type="text"  width="50" maxlength="10" name="class" placeholder="Please type the class you want"></td>
        <td>     <input type="text"  width="50" maxlength="10" name="uname" placeholder="Please type the class you want"></td>
