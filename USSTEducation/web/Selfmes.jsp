...
<form action="StuliuyanServlet" method="post">
    <table id="customers">
        ...
        <c:forEach var="m" items = "${applicationScope.selfmes}" varStatus="status">
            <tr>
                <td><span>${m.messageId}</span></td>
                ...
                <td><a type="button" class="btn btn-xs btn-warning" href="MessmodifyServlet?messid=${m.messageId}">修改</a>
                    <a type="button" class="btn btn-xs btn-danger" href="MessDeleteServlet?messid=${m.messageId}">删除</a></td>
            </tr>
        </c:forEach>
    </table>
</form>
