...
<div class="container">
    ...
    <div class="container theme-showcase" role="main">
        ...
        <div class="row">
            <div class="col-md-6">
                <form action="AdmNewteaServlet" method="post">
                <table class="table table-striped">
                    ...
                    <tbody>
                    <c:forEach var="c" items = "${applicationScope.alltt}" varStatus="status">
                        <tr>
                            <td><span>${c.teacherid}</span></td>
                            <td><span>${c.tname}</span></td>
                            <td><span>${c.tpassword}</span></td>
                            <td><span>${c.tclass}</span></td>
                            <td><span>${c.tinfo}</span></td>
                        </tr>
                    </c:forEach>
                    <tr>
                        <td><span><label><input type="text" value="请输入教师编号" name="newtid" required></label></span></td>
                        <td><span><label><input type="text" value="请输入教师姓名" name="newname" required></label></span></td>
                        <td><span><label><input type="text" value="请输入教师密码" name="newpass" required></label></span></td>
                        <td><span><label><input type="text" value="请输入教师学院" name="newdept" required></label></span></td>
                        <td><span><label><input type="text" value="请输入教师信息" name="newinfo" required></label></span></td>
                    </tr>
                    </tbody>
                </table>
